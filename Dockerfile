...
#
#   docker build --build-arg PHP_VERSION=8.4 --tag transformer-dev .
#   docker run --rm --volume "$PWD":/app transformer-dev composer install
#   docker run --rm --volume "$PWD":/app transformer-dev phpunit
#
